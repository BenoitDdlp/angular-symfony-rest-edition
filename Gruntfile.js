...
//            },
        ...
        ngtemplates: {
            app: {
                ...
                options: {
                    ...
                    {
                        return "angular.module('asreApp', []).run(['$templateCache', function ($templateCache) {\n" + script + "}])";
                    }
                }
            },
            ...
            modules: {
                ...
                options: {
                    url: function (url)
                    {
                        // return  url.replace('frontend/.tmp/templates/app/', 'http://localhost/asre/frontend/dist/templates');
                        return url.replace('frontend/app/', 'http://localhost/frontend/dist/');
        ...
        'sf2-console': {
            ...
            database_init: {
                cmd: 'asre:database:init'
            },
            //create an admin user on the system
            admin_create: {
                cmd: 'asre:admin:create admin admin@admin.fr admin'
            },
            ...
            copy_ws_config: {
                cmd: 'asre:wsconfig:copy --to-path <%= yeoman.app %>/js/ws-config.js --server-base-path <%= yeoman.local_config.serverRootPath %>'
            }
        }
