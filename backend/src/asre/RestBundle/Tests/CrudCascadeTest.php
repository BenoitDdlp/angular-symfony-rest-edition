...
namespace asre\RestBundle\Tests;

use Liip\FunctionalTestBundle\Test\WebTestCase;

class CrudCascadeTest extends WebTestCase
{
  const LOCATION_CLASS = "asre/RestBundle/Tests/Fixtures/LocalizationFixture";
  ...
  public function testOneToOneOwningPostWithNewLinkedEntity()
  {
    ...
    $entity = new \asre\ContentBundle\Entity\Localization();
//    $entity = $this->em->getRepository($entityClassName)->find($id);
    $method = "POST";
    $this->em->getRepository("asre\\ContentBundle\\Entity\\Localization");
