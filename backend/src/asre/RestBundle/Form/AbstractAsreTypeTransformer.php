...
abstract class AbstractAsreTypeTransformer implements DataTransformerInterface
{
  ...
  {
    //transform asre\ContentBundle\Form\LocationType
    //       to asre\ContentBundle\Entity\LocationType
    $className = preg_replace('/\\\\Form\\\\/', '\\Entity\\', get_class($formType), 1);

    //transform asre\ContentBundle\Entity\LocationType
    //       to asre\ContentBundle\Entity\Location
