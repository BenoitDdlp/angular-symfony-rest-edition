 ...
 * @ORM\Entity(repositoryClass="asre\CommunityBundle\Repository\PositionRepository")
...
class Position
{
   ...
   *
   * @ORM\ManyToOne(targetEntity="asre\CommunityBundle\Entity\Person", inversedBy="positions")
  ...
  /**
   * @ORM\ManyToOne(targetEntity="asre\CommunityBundle\Entity\Organization", inversedBy="positions")
