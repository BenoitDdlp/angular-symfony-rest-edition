...
class FOSUBUserProvider extends BaseFOSUBUserProvider
{
   ...
   * @param \asre\SecurityBundle\Services\Mailer              $mailer
   * @param UserService                                       $userService
   */
  public function __construct(UserManagerInterface $userManager, array $properties, Session $session, Mailer $mailer, UserService $userService)
  {
