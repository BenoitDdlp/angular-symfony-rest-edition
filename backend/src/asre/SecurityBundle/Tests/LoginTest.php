...
namespace asre\SecurityBundle\Tests;
...
class LoginTest extends WebTestCase
{
  ...
  /**
   * test command asre:admin:create admin2 admin2@admin.fr admin2
   */
  public function testCreateUser()
  {
    $output = $this->runCommand($this->client, "asre:admin:create " . $this->user["username"] . " " . $this->user["email"] . " " . $this->user["password"]);
