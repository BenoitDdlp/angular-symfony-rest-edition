...
namespace asre\TweetsBundle\Controller;

use asre\SecurityBundle\Services\TwitterAPI;
...
class TwitterApiSearchTagController extends FOSRestController
{
   ...
   *
   * @Rest\Get("/twitter-api/search/timeline/{tag}", defaults={"tag"="@asre"})
   */
  public function apiAction($tag, Request $request)
  {
    ...
    $twitter = $this->get('asre_security.twitter');
