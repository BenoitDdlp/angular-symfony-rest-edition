...
namespace asre\ImportBundle\Controller;
...
class ImportController extends FOSRestController
{
  ...
  const IMPORTER_ANNOTATION = 'asre\\ContentBundle\\Annotation\\Importer';
  ...
  {
    $header = $this->get('asre_import.import_config_service')->fromShortClassName($entityLabel, true);
   ...
   * @return
   */
  public function postImportAction(Request $request, ParamFetcherInterface $paramFetcher, $entityLabel)
  {
    //TODO : secure this?
    ...
    $return = $this->get('asre_import.import_service')->importEntities($datas, $entityLabel);
