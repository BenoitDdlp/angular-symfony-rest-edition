/**
 * asreEventDaysDropdown
 * Generate a selectable dropdown with days entry calaculated from a date to another
 * use it like :
 * <div class="col-sm-6" asre-event-days-dropdown start="{{event.startAt}}" end="{{event.endAt}}" model="event.selectedDay">
 ...
 */
angular.module('asreApp').directive('asreEventDaysDropdown',['dateDaysDifferenceFact', 'translateFilter', function (dateDaysDifferenceFact, translateFilter)
{
    return {
        restrict: 'AE',
        ...
        link: function (scope, element, attrs)
        {
            ...
            {
                return console.error('missing mandatory field in "asreEventDaysDropdown" directive (see doc above)');
            }
