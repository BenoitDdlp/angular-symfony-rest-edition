 ...
 * use it like :
 * <div class="row"
 *      ng-include="'modules/authentication/partials/views/persons-entity-row-lg.html'"
 *      asre-with-locals locals-person="teammate.person"
 *      ></div>
 *  in example to access the "teammate.person" as {{ person }} in this directive scope
 */
angular.module('asreApp').directive('asreWithLocals', function ()
{
    return {
        scope  : true,
