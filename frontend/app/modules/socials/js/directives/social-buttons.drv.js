        ...
        function() {
            ...
            return {
                ...
                template: '<li>' +
                    ...
                    '<img class="ng-social-icon" src="assets/img/Facebook.png "/>' +
                    '</span>' +
        ...
        function() {
            ...
            return {
                ...
                template: '<li>'+
                    ...
                    '<span class="ng-social-icon">'+
                    '<img class="ng-social-icon" src="assets/img/GooglePlus.png "/>'+
                    '</span>'+
                    '<span class="ng-social-text" ng-transclude></span>'+
                    '</a>'+
                    '<span ng-show="count" class="ng-social-counter">{{ count }}</span>'+
        ...
        function() {
            ...
            return {
                ...
                template: '<li>' +
                    ...
                    ' class="ng-social-button">' +
                    '<span class="ng-social-icon">' +
                    '<img class="ng-social-icon" src="assets/img/Linkedin.png"/>' +
                    '</span>' +
                    '<span class="ng-social-text" ng-transclude></span>' +
                    '</a>' +
                    '<span ng-show="count" class="ng-social-counter">{{ count }}</span>' +
        ...
        function() {
            ...
            return {
                ...
                template: '<li>'+
                    '<a ng-href="{{ctrl.link(options)}}" target="_blank" ng-click="ctrl.clickShare($event, options)" class="ng-social-button">' +
                    '<span class="ng-social-icon">' +
                    '<img class="ng-social-icon" src="assets/img/Twitter.png"/>' +
                    '</span>' +
                    '<span class="ng-social-text" ng-transclude></span>' +
                    '</a>'+
                    '<span ng-show="count" class="ng-social-counter">{{ count }}</span>' +
