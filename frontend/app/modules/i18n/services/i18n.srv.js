 ...
 * @type {Service}
 */
angular.module('i18nApp').factory('i18nSrv', [
  '$translate',
  function ($translate)
{
    var i18nSrv = {
        ...
        locals : [
            { label: 'English', code: 'en_US', src: 'assets/img/english-flag.png'},
            { label: 'Français', code: 'fr_FR', src: 'assets/img/french-flag.png'}
        ],
