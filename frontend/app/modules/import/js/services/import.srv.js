 ...
 * @type {factory}
 */
angular.module('importApp').factory('importService', [
    'importFact',
    function (importFact)
    {
        var entityLbl,
        ...
        return {
            ...
            send         : function (data, commit, success, error)
            {
                console.log("Sending " + data.length + " entity(ies) : ", data);
                new importFact(data).$import({entityLabel: entityLbl, commit: commit}, success, error);
            }
        };
    }
]);
